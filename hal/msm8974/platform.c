...
#define SDM_710_MIXER_XML_PATH "/vendor/etc/mixer_paths_intcodec_s4.xml"
...
static int acdb_device_table[SND_DEVICE_MAX] = {
    ...
    [SND_DEVICE_OUT_SPEAKER_SAFE] = 514,
    ...
    [SND_DEVICE_OUT_VOICE_HAC_HANDSET] = 201,
    ...
    [SND_DEVICE_IN_VOICE_USB_HEADSET_MIC] = 78,
